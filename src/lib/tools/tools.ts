...
export const KRYPTONAL_TOOLS: KryptonalTool[] = [
  ...
  {
    slug: "token-unlock-impact-simulator",
    nameKey: "tokenUnlock.name",
    descriptionKey: "tokenUnlock.description",
    benefitKey: "tokenUnlock.benefit",
    category: "finance",
    status: "live",
    href: "/tools/token-unlock-impact",
    icon: "🔓",
    usageCount: 842,
  },
  {
  ...
  {
    slug: "airdrop-points-value-calculator",
    nameKey: "airdropCalc.name",
    descriptionKey: "airdropCalc.description",
    benefitKey: "airdropCalc.benefit",
    category: "defi",
    status: "live",
  ...
  {
    slug: "bundled-sniper-rugpull-analyzer",
    nameKey: "rugPullAnalyzer.name",
    descriptionKey: "rugPullAnalyzer.description",
    benefitKey: "rugPullAnalyzer.benefit",
    category: "security",
    status: "live",
    href: "/tools/rugpull-analyzer",
    icon: "🛡️",
    usageCount: 701,
  },
  {
  ...
  {
    slug: "crypto-etf-tracker",
    nameKey: "cryptoEtfTracker.name",
    descriptionKey: "cryptoEtfTracker.description",
    benefitKey: "cryptoEtfTracker.benefit",
    category: "market",
    status: "live",
  ...
  },
  {
    ...
    nameKey: "cryptocurrencyConverter.name",
    descriptionKey: "cryptocurrencyConverter.description",
    benefitKey: "cryptocurrencyConverter.benefit",
    category: "market",
    status: "live",
